...
static void init_x16rt(const int thr_id, const int dev_id)
{
	...
	//THE1 tried different number 20:19 this still works best
	...
	if (gpu_model > 1070) intensity = 28;
	else if (gpu_model > 1060) intensity = 26;
	else if (gpu_model > 1000) intensity = 20;
...
extern "C" void free_x16rt(int thr_id)
{
	...
	//cudaThreadSynchronize(); // THE1 Faster Without
